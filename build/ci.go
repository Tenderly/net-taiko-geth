...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/tenderly/net-taiko-geth/core/rawdb", "github.com/tenderly/net-taiko-geth/ethdb/leveldb"},
		{"github.com/tenderly/net-taiko-geth/core/rawdb", "github.com/tenderly/net-taiko-geth/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
